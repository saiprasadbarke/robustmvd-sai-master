...
from .blocks.dispnet_decoder_3d_downsample import DispnetDecoder3DDownSample
...
class MVSNetDispnetDecoder3DDownSample(nn.Module):
    def __init__(self, num_sampling_points=128, sampling_type="linear_depth"):
        ...
        self.decoder = DispnetDecoder3DDownSample(arch="mvsnet")
...
@register_model
def mvsnet_dispnet_decoder_3d_downsample(
    ...
    model = build_model_with_cfg(
        model_cls=MVSNetDispnetDecoder3DDownSample,
        weights=weights,
        train=train,
        num_gpus=num_gpus,
