...
class MVSNet_Unet(nn.Module):
    def __init__(self, num_sampling_points=128, sampling_type="linear_depth"):
        ...
        self.fusion_enc_block = MVSNetFusedCostvolumeEncoder(
            in_channels=16, base_channels=8, batch_norm=True
        )
...
@register_model
def mvsnet_unet(pretrained=True, weights=None, train=False, num_gpus=1, **kwargs):
    assert not (
