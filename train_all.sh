...
python eval.py --eval_type robustmvd --model robust_mvd --weights ${OUT_BASE}/robust_mvd/weights_only_checkpoints_dir/snapshot-iter-000600000.pt --inputs poses intrinsics --output ${OUT_BASE}/robust_mvd/eval --log_dir ${OUT_BASE}/robust_mvd --num_gpus ${NUM_GPUS} --eth3d_size 768 1152 --kitti_size 384 1280 --dtu_size 896 1216 --scannet_size 448 640 --tanks_and_temples_size 704 1280 --evaluate_uncertainty --seed 42 ${enable_wandb}

python train.py --training_type mvd --output ${OUT_BASE}/mvsnet_blendedmvs --num_gpus ${NUM_GPUS} --batch_size 1 --max_iterations 160000 --model mvsnet_blendedmvs --inputs poses intrinsics depth_range --optimizer rmsprop --lr 1e-3 --scheduler mvsnet_scheduler --loss mvsnet_loss --dataset blendedmvs.robust_mvd.mvd --augmentations mvsnet_augmentations --seed 42 ${enable_wandb}
